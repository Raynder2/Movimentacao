...
if(messagebox.askquestion("Confirmação", "Iniciar automoção?",icon ='info') == 'yes'):
  ...
  document.body.removeChild(textArea);
    ...
    pg.hotkey('ctrl','v')
            ...
            # time.sleep(.5)
            # pg.click(x=1577, y=397)
            # pg.write("frame.querySelector('select[name=\"txt_in_sit_freq_sif_novo\"]').value = 3;")
            ...
            # pg.write("frame.querySelector('input[name=\"txt_ds_mot_hs_sif\"]').value = 'INATIVAÇÃO DE SERVIDOR';")
            # pg.write("frame.querySelector('input[name=\"txt_dt_ini_freq_novo\"]').value = '30/09/2021';") #Definir inicio
            # pg.write("frame.querySelector('input[name=\"txt_dt_fim_freq\"]').value = '29/09/2021';") #De
